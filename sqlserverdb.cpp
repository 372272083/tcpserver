...
SqlserverDB::SqlserverDB(QString dbsource,QString host,QString username,QString password)
{
...
bool SqlserverDB::createtable(QString sql)
{
    QSqlQuery sql_query;
...
bool SqlserverDB::updatasql(QString sql)
{
...
int SqlserverDB::querysqlcount(QString sql)
{
    QSqlQuery sql_query(database);
...
QVector<QString> SqlserverDB::query(QString sql,QString seperator)
{
...
QMap<int,QString> SqlserverDB::queryWaveSql(int type)
{
...
QMap<int,QMap<QString,QString>> SqlserverDB::queryFeatureSql(int type,QString dtime,int tolance)
{
...
bool SqlserverDB::execSql(QString sql,QMap<QString,QVariantList> binds)
{
    if (!database.isOpen())
    {
        return false;
...
bool SqlserverDB::execSql(QQueue<QString> sqls)
{
    if (!database.isOpen())
    {
        return false;
...
QSqlTableModel* SqlserverDB::model(QString table,QStringList headers)
{
...
QSqlTableModel* SqlserverDB::modelNoHeader(QString table)
{
    QSqlTableModel *model = new QSqlTableModel(nullptr,database);
    model->setTable(table);
    model->select();
...
int SqlserverDB::getMaxId(QString table)
{
    QSqlQuery sql_query(database);
...
void SqlserverDB::close()
{
    database.close();
}

bool SqlserverDB::status()
{
